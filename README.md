...
# José Vinicius da Silva de Souza

**Software Engineer · M.Sc. Student in Applied Computing**

Backend Engineering · Distributed Systems · Computer Vision · Deep Learning
...
Sou engenheiro de software com foco em **backend, arquitetura e sistemas distribuídos**, atuando principalmente com Java, Spring Boot e PostgreSQL.

Também sou mestrando em **Computação Aplicada**, com pesquisa em **Visão Computacional e Deep Learning**. Meu objetivo é aproximar engenharia de software e pesquisa aplicada para construir soluções robustas, reproduzíveis e úteis em problemas reais.

Tenho interesse especial por decisões técnicas relacionadas a **concorrência, consistência, escalabilidade, desempenho e operação de sistemas**.
...
- Avaliação com accuracy, top-k accuracy e matriz de confusão
- Experimentos reproduzíveis com TensorFlow e Keras
...
Estudos e implementações sobre concorrência na JVM: virtual threads, executors, sincronização, semáforos e diagnóstico de problemas concorrentes.

### [MCP Easy Setup](https://github.com/viniciusscience/mcp-easy-setup)

Extensão para Visual Studio Code criada para simplificar a configuração de integrações MCP.

---

<div align="center">

**Software Engineering · Distributed Systems · Computer Vision · Deep Learning**
